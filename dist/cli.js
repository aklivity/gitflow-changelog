...
async function resolveHashes(input, gitOptions) {
  ...
  const defaultBranch = input.github && stillPending.some((entry) => entry.kind === "pr") ? await fetchDefaultBranch(input.github.owner, input.github.repo, input.github.token) : void 0;
